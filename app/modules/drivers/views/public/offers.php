<div>
		...
		<div class="m-portlet__head m-portlet__head--fit">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-action">
					...
					<button type="button" class="btn btn-sm m-btn--pill m-btn--air btn-brand mr-2"><?php echo $offers_count; ?> Offers</button>
	...
	<h3 class="fancy_title my-3">
		<?php echo $user->first_name." ".$user->last_name; ?> - Offers made on posts on <?php echo $this->settings->application_name; ?>
	</h3>
...
<script>
	...
	$(window).on('load',function(e){
    	...
    	load_users_posts_with_offers_made(user_id,first_uri_segment,second_uri_segment,get_string);
    	//e.stopPropagation();
	});
</script>