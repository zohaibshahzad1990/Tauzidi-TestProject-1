	...
	<div class="kt-portlet__body">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group m-form__group">
					...
					<?php echo form_input('national_id',$post->national_id,'class="form-control m-input m-input--air" placeholder="National Id"');?>
					<span class="m-form__help">
					</span>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group m-form__group">
					<label for="">
						Vehicle Assigned <span class="required">*</span>
					</label>
					<?php echo form_dropdown('vehicle_id',array(''=>'Select Vehicle'), "", ' class="form-control m-input m-input--air kt-select2" id ="vehicle_holder" placeholder="Vehicle Id"');?>
					<span class="m-form__help">
					</span>
				</div>
			</div>
