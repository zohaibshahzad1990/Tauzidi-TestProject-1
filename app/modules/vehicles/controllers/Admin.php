...
class Admin extends Admin_Controller{
    ...
    function create(){
    	...
    	if($this->form_validation->run()){
    		...
    		redirect('admin/vehicles/listing','refresh');
    	}else{
    ...
    function listing(){
        ...
        $pagination = create_pagination('admin/vehicles/listing/pages', $total_rows,100,5,TRUE);
